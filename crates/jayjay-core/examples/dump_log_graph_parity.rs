//! Manual real-CLI parity dump for the real-repository validation described in
//! `docs/jj-log-dag-parity-plan.md`. Prints JayJay's unprojected structural ASCII graph
